...
def formula3p7(c,r,t):
    #Formula 3.7 for Macauley duration of bond
    #with annual coupon c, t years to
    #maturity, discount rate r
    if r<=-100:  #Unreasonable discount rate
        return(0)
    ...
    duration/=price
    return(duration)
#Done with Formula3p7

def formula3p8(c,r,t):
    #Formula 3.8 for convexity of bond
    #with annual coupon c, t years to
    #maturity, discount rate r
    if r<=-100:  #Unreasonable discount rate
        return(0)
...
#Synchronize last date to date of printed book if necessary
    SynchBook = True
